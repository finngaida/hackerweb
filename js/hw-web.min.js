...
n();var b=a.slice(),c='<ul class="tableview tableview-links" id="hwlist">'+f.news.markupStories(b)+(amplify.store("hacker-news2")?'<li><a class="more-link">More&hellip;<span class="loader"><i class="icon-loading"></i></span></a></li>':"")+"</ul>";l.innerHTML=c,f.pub("onRenderNews")};if(b){var h=amplify.store("hacker-news"),i=a.delay;i?(m=!0,l.innerHTML=d.render({loading:!0}),setTimeout(function(){m=!1,e(h)},i)):e(h)}else{m=!0,l.innerHTML=d.render({loading:!0});var j=function(){l.innerHTML=d.render({
load_error:!0}),f.pub("logAPIError","news")};hnapi.news(function(a){return m=!1,!a||a.error?void j():(amplify.store("hacker-news",a),amplify.store("hacker-news-cached",!0,{expires:6e5}),amplify.store("hacker-news2",null),e(a),void hnapi.news2(function(a){a&&!a.error&&(amplify.store("hacker-news2",a),c("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip;<span class="loader"></span></a></li>'))}))},function(a){m=!1,j()})}}},reload:function(){f.news.render({delay:300})},more:function(a){
...
if(f.comments.currentID!=a||!c){f.comments.currentID=a;var d=function(a,c){var d=e(a),h=g("post-comments");if(d.has_post=!!d.title,!d.has_post)return f.setTitle(),p.innerHTML="",q.innerHTML=h.render(d),f.pub("adjustCommentsSection"),void f.pub("onRenderComments");var i=g("comments");if(/^item/i.test(d.url)?d.url="//news.ycombinator.com/"+d.url:d.domain=j(d.url),d.has_comments=d.comments&&!!d.comments.length,d.i_point=1==d.points?"point":"points",d.i_comment=1==d.comments_count?"comment":"comments",
